  ...
  <table class="widefat importers striped">
    <tbody>
      ...
      <tr>
        <td>
          <p>
            <?php _e('Import theme settings from .tinsta file.' .
                    ' Note that this will override all your current settings about the theme.', 'tinsta') ?>
          </p>
        </td>
        <td>
          <?php
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <p>
              <button name="tinsta-import"
                      value="1"
                      class="button"
                      onclick="return confirm('<?php _e('Do you want to continue?', 'tinsta') ?>')">
      ...
      <tr>
        ...
        <td>
          ...
          <form method="post">
            <p>
              <button name="tinsta-reset" value="1" class="button button-link-delete"
                      onclick="return confirm('<?php _e('Do you want to continue?', 'tinsta') ?>')">
                <?php _e('Reset', 'tinsta') ?>
              </button>
            </p>
