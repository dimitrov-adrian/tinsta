...
class Tinsta_UserMenu_Widget extends WP_Widget
{
  ...
  function form($instance)
  {
    ...
    <p>
      <label for="<?php echo $this->get_field_id('loggedin_menu') ?>">
        <?php _e('Menu when Logged', 'tinsta') ?>
      </label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('loggedout_menu') ?>">
        <?php _e('Menu when Logged-Out', 'tinsta') ?>
      </label>
